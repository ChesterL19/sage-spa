      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className=" text-sm">
              Sage Spa is a luxurious spa that offers a wide range of services
              to help you relax and rejuvenate.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-medium mb-4 text-white uppercase tracking-wide">
              Quick Links
            </h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 uppercase tracking-wide text-white">
              Hours
            </h3>
            <ul className="space-y-2 text-sm">
