  ...
  const team = [
    {
      ...
      description:
        "With over 10 years of experience, Sarah specializes in deep tissue and therapeutic massage.",
      image: "/work1.jpg",
    },
    {
      id: 2,
      ...
      description:
        "Sarah brings expertise in advanced skincare treatments and anti-aging techniques.",
      image: "/work2.jpg",
    },
    {
      id: 3,
      ...
      description:
        "Maria ensures every guest receives personalized care and a rejuvenating experience.",
      image: "/work3.jpg",
    },
  ];
  return (
    <main className="bg-amber-50/90 min-h-screen">
        ...
        <div className="relative w-full max-w-6xl">
          <div className="relative  rounded-3xl p-12 lg:p-20">
            ...
            <div className="relative z-10 text-center">
              ...
              <Link
                href="/book"
                className="bg-amber-900 text-white px-8 py-4 rounded-lg text-lg font-medium hover:bg-amber-800 transition-colors inline-block"
              >
                Book Now
              </Link>
            </div>
        ...
        <div className="relative w-full max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 justify-items-center">
            {services.map((service) => (
              <div
                key={service.id}
                className={`${service.bgColor} rounded-bl-3xl border border-gray-200 p-8 hover:shadow-lg transition-shadow flex flex-col w-full max-w-sm min-h-[400px]`}
              >
                {/* Icon Area */}
                <div className="mb-6">
                ...
                <div className="flex justify-end mt-auto">
                  <a
                    href="/services"
                    className="flex items-center gap-2 text-gray-900 uppercase text-sm font-medium hover:gap-4 transition-all"
                  >
                    LEARN MORE
      ...
      <section
        id="team"
        className="min-h-screen flex items-center justify-center px-4 py-20 bg-amber-50/90"
      >
        <div className="relative w-full max-w-7xl mx-auto">
          <h2 className="text-4xl lg:text-5xl font-serif text-amber-900 mb-16 text-center">
            Meet the Team
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {team.map((member) => (
              <div
                key={member.id}
                className="bg-white rounded-[100px] overflow-hidden shadow-lg hover:shadow-xl transition-shadow"
              >
